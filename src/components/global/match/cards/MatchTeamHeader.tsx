...
import MatchTeamDropDownMenu from "./MatchTeamDropDownMenu";

type MatchTeamHeaderProps = {
  role: "user" | "coach" | "member";
} & Team;

const MatchTeamHeader: React.FC<MatchTeamHeaderProps> = (props) => {
  return (
    <Card
    ...
    >
      ...
      <CardContent className="flex items-center justify-center gap-4 m-0 p-0">
        <span>3.5K</span>
        <Star />
        <MatchTeamDropDownMenu teamname={props.teamName} role={props.role} />
      </CardContent>
    </Card>
  );
};
