  ...
  return (
    ...
    >
      ...
      <CardContent className="flex items-center justify-center gap-4 m-0 p-0">
        <MemberDropDownMenu teamId={props.member.team_id} uid={props.member.uid} role={props.role} isAdmin={props.member.role === "coach"} username={props.member.userInfo?.username || ''} userInfo={props.member.userInfo} />
      </CardContent>
    </Card>
  );
};
